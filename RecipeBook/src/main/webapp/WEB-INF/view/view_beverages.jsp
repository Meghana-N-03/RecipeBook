...
<head>
    ...
    <style>
        body {
            margin: 0;
            padding: 0;
            background-image: url("<c:url value="/Resources/img/b.jpg" />");
...
<body>
    ...
    <div class="container">
        <form class="search-form" action="${pageContext.request.contextPath}/user/search_beverages" method="GET">
            <div class="input-group">
                <input type="text" class="form-control" name="query" placeholder="Search for Beverages">
                    ...
                    <div class="col-md-10 offset-md-1 mt-2">
                        <div class="card">
                            ...
                            <h4>Recipe Title:</h4>
                                ...
                                <h4>Recipe:</h4>
                                <p>${n.description }</p>
                                <form action="${pageContext.request.contextPath}/user/likeRecipe" method="POST">
