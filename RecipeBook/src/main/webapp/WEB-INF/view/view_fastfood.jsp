...
<head>
    ...
    <style>
        body {
            margin: 0;
            padding: 0;
            background-image: url("<c:url value="/Resources/img/yel.jpg" />");
...
<body>
    ...
    <div class="container">
        <form class="search-form" action="${pageContext.request.contextPath}/user/search_fas" method="GET">
            <div class="input-group">
                <input type="text" class="form-control" name="query" placeholder="Search for fastfood recipes">
                <button type="submit" class="btn btn-primary">Search</button>
            </div>
        </form>
        <div class="add-recipe-form">
            <h4 class="text-center">Fastfood</h4>
                            ...
                            <div class="card-body">
                             <h4>Recipe Title:</h4>
                                <p>${n.title }</p>
                                   <h4>Recipe:</h4>
                                <p>${n.description }</p>
                                <form action="${pageContext.request.contextPath}/user/likeFastfood" method="POST">
