...
<body>
    ...
    <div class="container">
        <form class="search-form" action="${pageContext.request.contextPath}/user/search_des" method="GET">
            <div class="input-group">
                <input type="text" class="form-control" name="query" placeholder="Search for desserts">
                            ...
                            <div class="card-body">
                             <h4>Recipe Title:</h4>
                                <p>${n.title }</p>
                                   <h4>Recipe:</h4>
                                <p>${n.description }</p>
                                <form action="${pageContext.request.contextPath}/user/likeDesserts" method="POST">
